...
public class update2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			preparedStatement = connection.prepareStatement("update cust set fname=?,lname=?,street=?,address=?,city=?,state=?,email=? where phone=?;");
			...
			try {
				...
				printWriter.println("Unable to update!!");
			}
